...
[Open in Docker Dev Environments <img src="../open_in_new.svg" alt="Open in Docker Dev Environments" align="top"/>](https://open.docker.com/dashboard/dev-envs?url=https://github.com/YYUYYJ/awesome-compose/tree/master/nginx-golang-postgres-rabbitmq)
